ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :blog_subcategories
  map.resources :blog_categories, :member => {:articles => :get}
  ...
  map.admin_payments 'admin/payments', :controller => "admin/payments", :action => "index" 
